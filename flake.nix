{
  description = "Codictate - A free, open source, and extensible speech-to-text application that works completely offline";
      ...
      devShells = forAllSystems (
        ...
        in
        {
          default = pkgs.mkShell {
            ...
            shellHook = ''
              echo "Codictate development environment"
              bun install
