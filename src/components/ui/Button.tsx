...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseClasses =
    "flex items-center justify-center font-medium rounded border focus:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed cursor-pointer";
